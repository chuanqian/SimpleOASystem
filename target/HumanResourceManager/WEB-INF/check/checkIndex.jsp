    ...
    <div data-options="region:'center',border:false">
        ...
        <div id="wu-toolbar">
            ...
            <div class="wu-toolbar-search">
                ...
                <label>考勤类型：</label>
                <select id="checkstatusid" class="easyui-combobox" panelHeight="auto" style="width:100px">
                </select>
                <label>被考勤员工姓名：</label><input id="staffname" class="wu-text" style="width:100px">
...
<script type="text/javascript">
    ...
    function opensearch() {
        ...
        var statusid = $("#checkstatusid").combobox("getValue");
        var staffname = $("#staffname").val();
        var url = 'showCheckRecord.check?startTime='+starttime+"&endTime="+endtime+"&checkTypeId="+statusid+"&staffName="+staffname;
        console.log(url);
        openthe(url);
    }
    ...
    function openthe(url) {
        $('#wu-datagrid').datagrid({
            ...
            columns: [[
                {checkbox: true},
                {field: 'staffBeiName', title: '考勤员工', width: 100},
                {field: 'typeName', title: '考勤类型', width: 100},
                {field: 'checkTime', title: '考勤时间', width: 100},
                {field: 'checkMoney', title: '奖惩金额', width: 100},
                {field: 'staffName', title: '考勤人', width: 100}
