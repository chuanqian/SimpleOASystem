...
<%--                <a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="openAdd()" plain="true">添加</a>--%>
                <a href="#" class="easyui-linkbutton" iconCls="icon-edit" onclick="openEdit()" plain="true">调动</a>
    ...
    <form id="wu-form" method="post">
        <table>
            <tr>
                ...
                <td>
                    <input type="hidden" name="personnelStaffUid" class="wu-text"/>
                    <input type="text" name="sName" class="wu-text" readonly="readonly"/>
                </td>
            </tr>
            <tr>
                <td align="right">原职务:</td>
                <td><input type="text" name="positionName" class="wu-text" readonly="readonly"/></td>
            </tr>
            <tr>
                <td align="right">新职务:</td>
                <td>
                    <select name="personnelNewPositionId" class="wu-text easyui-combobox" panelHeight="auto" id="pn">
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <textarea rows="auto" cols="auto" name="personnelCause" class="wu-text"></textarea>
                </td>
            </tr>
        </table>
    </form>
