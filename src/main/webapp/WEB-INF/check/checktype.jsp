    ...
    <form id="wu-form" method="post">
        <table>
            <tr>
                ...
                <td>
                    <input type="hidden" name="checkTypeId" class="wu-text"/>
                    <input id="cty" type="text" name="checkTypeName" class="wu-text" readonly="readonly"/>
                </td>
            </tr>
            <tr>
                <td align="right">奖惩金额:</td>
                <td><input type="text" name="checkTypeMoney" class="wu-text"/></td>
            </tr>
...
<script type="text/javascript">
        ...
        $.messager.confirm('信息提示', '确定要删除该记录？', function (result) {
            if (result) {
                ...
                $(items).each(function () {
                    ...
                    ids += this.checkTypeId + ","
                });
                console.log(ids)

                $.ajax({
                    url: 'removeCheckType.check',
                    data: {id: ids},
                    success: function (data) {
                        if (data) {
    ...
    $('#wu-datagrid').datagrid({
        url: 'getAllCheckTypeBySql.check',
        method: "get",//提交方式
        ...
        columns: [[
            {checkbox: true},
            {field: 'checkTypeName', title: '类型名称', width: 100},

            {field: 'checkTypeMoney', title: '奖惩金额', width: 100}
