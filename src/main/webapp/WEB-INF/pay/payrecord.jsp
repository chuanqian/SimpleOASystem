...
<script type="text/javascript">
    ...
    function opensearch() {
        ...
        var url='getAllPayRecord.pay?startTime='+starttime+"&endTime="+endtime+"&staffName="+staffname;
        enterthe(url);
    }
     ...
     */
    enterthe('getAllPayRecord.pay');
    function enterthe(url) {
        $('#wu-datagrid').datagrid({
            ...
            columns: [[
                ...
                {field: 'basicNum', title: '基本工资', width: 100},
                {field: 'mertisNum', title: '绩效工资', width: 100},
                {field: 'payRewords', title: '奖金金额', width: 100},
                {field: 'payFine', title: '处罚金额', width: 100},
                {field: 'payTotal', title: '工资总额', width: 100},
                {field: 'payTime', title: '工资发放时间', width: 100}
