    ...
    <div data-options="region:'center',border:false">
        ...
        <div id="wu-toolbar">
            ...
            <div class="wu-toolbar-search">
                ...
                <%--<label>基本工资：</label><input id="basic" class="wu-text" style="width:100px">
...
<div id="wu-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'"
    ...
    <form id="wu-form" method="post">
        <table>
            <tr>
                <td width="60" align="right">基本:</td>
                <td>
                    <input type="hidden" name="basicMoneyId" class="wu-text"/>
                    <input type="text" name="basicMoneyNum" class="wu-text"/>
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    // function opensearch() {
    //     var basic=$("#basic").val();
    //     var url='getAllBaiscMoneyBySql.basic?basic='+basic;
    //     openthe(basic);
    // }
    ...
    function edit() {
        ...
        $('#wu-form').form('submit', {
            url: 'editBasicByBasicMoneyId.basic',
            success: function (data) {
                var data = eval('(' + data + ')');
                if (data) {
                    $.messager.alert('信息提示', '提交成功！', 'info');
        ...
        $.messager.confirm('信息提示', '确定要删除该记录？', function (result) {
            if (result) {
                ...
                $(items).each(function () {
                    ...
                    ids += this.basicMoneyId + ","
                });
                console.log(ids);

                $.ajax({
                    url: 'removeBasicMoneyByIds.basic',
                    data: {id: ids},
                    success: function (data) {
                        if (data) {
    ...
    openthe('getAllBaiscMoneyBySql.basic');
    ...
    function openthe(url) {
        $('#wu-datagrid').datagrid({
            ...
            columns: [[
                {checkbox: true},
                {field: 'basicMoneyNum', title: '基本工资', width: 100}
            ]]
        });
    }
</script>